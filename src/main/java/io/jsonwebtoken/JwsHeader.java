...
public interface JwsHeader<T extends JwsHeader<T>> extends Header<T> {
     ...
     * using {@link SignatureAlgorithmName#forName(String) SignatureAlgorithmName.forName} to convert this
     ...
     *
     * <p>The algorithm header parameter identifies the cryptographic algorithm used to secure the JWS.  Consider
     * using a type-safe {@link SignatureAlgorithmName SignatureAlgorithmName} instance and using its
     * {@link SignatureAlgorithmName#getValue() value} as the argument to this method.</p>
     *
