...
public enum SignatureAlgorithmName {
    ...
    SignatureAlgorithmName(String value, String description, String familyName, String jcaName, boolean jdkStandard) {
        this.value = value;
    ...
    /**
     * Looks up and returns the corresponding {@code SignatureAlgorithmName} enum instance based on a
     * case-<em>insensitive</em> name comparison.
     *
     * @param value The case-insensitive name of the {@code SignatureAlgorithmName} instance to return
     * @return the corresponding {@code SignatureAlgorithmName} enum instance based on a
     * case-<em>insensitive</em> name comparison.
     * @throws SignatureException if the specified value does not match any {@code SignatureAlgorithmName}
     *                            name.
     */
    public static SignatureAlgorithmName forName(String value) throws SignatureException {
        for (SignatureAlgorithmName alg : values()) {
